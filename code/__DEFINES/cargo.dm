...
GLOBAL_LIST_INIT(podstyles, list(\
	list(POD_SHAPE_NORML, "pod",         TRUE, "default",		"yellow",   RUBBLE_NORMAL,	"supply pod", 						    "A Genesis supply drop pod."),\
	list(POD_SHAPE_NORML, "advpod",      TRUE, "bluespace",	"blue",     RUBBLE_NORMAL,	"bluespace supply pod" , 			    "A Genesis Bluespace supply pod. Teleports back to CentCom after delivery."),\
	list(POD_SHAPE_NORML, "advpod",      TRUE, "centcom",		"blue",     RUBBLE_NORMAL,	"\improper CentCom supply pod", 		"A Genesis supply pod, this one has been marked with Central Command's designations. Teleports back to CentCom after delivery."),\
	...
	list(POD_SHAPE_NORML, "darkpod",     TRUE, "deathsquad",	"blue",     RUBBLE_NORMAL,	"\improper Deathsquad drop pod", 	    "A Genesis drop pod. This one has been marked the markings of Genesis's elite strike team."),\
	list(POD_SHAPE_NORML, "pod",         TRUE, "cultist",		"red",      RUBBLE_NORMAL,	"bloody supply pod", 				    "A Genesis supply pod covered in scratch-marks, blood, and strange runes."),\
