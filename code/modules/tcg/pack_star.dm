...
/datum/tcg_card/pack_star/phazon
	name = "Phazon"
	desc = "The pinnacle of scientific research and pride of Genesis, Phazon uses cutting edge bluespace technology and expensive materials." //GS13 - Nanotrasen to Genesis
