...
/datum/tcg_card/pack_1/captain
	name = "Captain"
	desc = "Genesis hires a captain for every station. However, most of the time they just drink wishkey and secure the disk." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/captain_hardsuit
	...
	desc = "A heavily customised Apadyne Technologies Mk.2 R.I.O.T. Suit, rebuilt and refitted to Genesis's highest standards for issue to Station Captains." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/hos
	...
	desc = "Genesis hires most heads of staff based on their qualifications as being amicable, good at conflict resolution, ability to handle high-stakes situations, humanity, and desire to learn. Heads of Security only need a highschool degree." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/cyborg_engi
	...
	desc = "A common sight on Genesis Stations Engineering Shells maintain critical station systems in hazardous conditions." //GS13 - Nanotrasen to Genesis
	rules = "Asimov."
...
/datum/tcg_card/pack_1/assistant
	name = "Assistant"
	desc = "The lowest ladder on the Genesis Employment Ladder, Assistants are employed to help out with tasks deemed 'too menial for robots'." //GS13 - Nanotrasen to Genesis
	rules = "Greytide."
...
/datum/tcg_card/pack_1/inquisitor
	...
	desc = "Genesis officially doesn't believe in ghosts magic or anything that can't be solved with science. When you see someone show up in one of these let that remind you of that fact." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/lawyer
	name = "Lawyer"
	desc = "Genesis knows the value of a good lawyer. That's why they're all working hard at our home offices defending us from frivolous labor suits from lazy no-good employees who should be working hard instead of slacking off reading trading cards." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/clown
	name = "Clown"
	desc = "Every Genesis station has a clown on board as high command believes that a source of entertainment will reduce instances of murder-suicide on board Spinward Stations. The results of this hypothesis are as of yet unproven." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/cook
	name = "Cook"
	desc = "Every Genesis chef is trained in 3 cuisines of their choosing upon being hired alongside the closely guarded secret of Close Quarters Cooking." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/curator
	name = "Curator"
	desc = "In Genesis polls the Curator has ranked as the most pointless job on station much to the ire of the Curator's union. Thankfully we don't have to listen to them." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/sec_officer
	...
	desc = "Genesis would like to remind all employees to support their station security team; remember the boys in red keep you safe!" //GS13 - Nanotrasen to Genesis
	rules = "Squad Tactics."
	icon_state = "officer"
...
/datum/tcg_card/pack_1/detective
	name = "Security Officer"
	desc = "Genesis hires nothing but the best detectives to investigate crime on our stations. A penchant for cigarettes and outdated fashion isn't mandatory but is appreciated." //GS13 - Nanotrasen to Genesis
	rules = "Deadeye."
...
/datum/tcg_card/pack_1/scientist
	name = "Scientist"
	desc = "Rumours that Genesis hires 'mad scientists' are greatly exaggerated. Scientists are regularly screened to ensure that their insanity remains within acceptable limits." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/scientist_moth
	name = "Scientist(Moth)"
	desc = "Moths are a common sight in Genesis research departments acting as integral ideas guys for new clothing designs and lighting innovations." //GS13 - Nanotrasen to Genesis
	rules = ""
...
/datum/tcg_card/pack_1/roboticist
	name = "Roboticist"
	desc = "The roboticist's work is as close as Genesis legally allows its employees to come to necromancy." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/monkey
	name = "Monkey"
	desc = "Genesis seeks to phase out animal testing by 2570 in accordance with new TerraGov legislation. This will be replaced with more ethical solutions such as computer simulations or experimentation on Assistants." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/geneticist
	name = "Geneticist"
	desc = "Geneticists are tasked with manipulating human DNA to produce special effects. Genesis maintains a strict 'no superhero' policy for mutations following the Superhero Civil War of 2150." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/doctor
	name = "Medical Doctor"
	desc = "Genesis's doctors are well known for their ability to treat almost any ailment known to mankind... as well as causing a fair few in the process." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/paramedic
	name = "Paramedic"
	desc = "Genesis encourages all paramedics to think of others before themselves- if this means running through a plasma fire to save a colleague so be it." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/quartermaster
	name = "Quartermaster"
	desc = "Every Genesis station has a Quartermaster who controls the flow of cargo to and from the station and by extension to and from the hands of the crew. He's not given the distinction of being a head though. His job isn't hard enough." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/explorer
	name = "Explorer"
	desc = "The Genesis Explorers Corps boldly goes where humanity has never gone before. Or would if they weren't buried under mounds of bureaucracy." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/intern
	name = "Intern"
	desc = "All Genesis interns come with 3 things: A resume a desire to learn and vague promises that they're getting paid at some point. So don't be too rough on them." //GS13 - Nanotrasen to Genesis
...
/datum/tcg_card/pack_1/tough_choices
	name = "Tough Choices"
	desc = "Every Genesis employee will at some point be forced to make a tough choice. Make sure you make the right one!" //GS13 - Nanotrasen to Genesis
