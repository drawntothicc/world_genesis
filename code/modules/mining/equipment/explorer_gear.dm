...
/obj/item/clothing/suit/hooded/explorer/heva
	name = "HEVA suit"
	desc = "The Hazardous Environments extra-Vehicular Activity suit, developed by WanTon & Sons Perilous Mining and sold to Genesis for missions within inhospitable, mineral-rich zones. \
			Its sleek plating deflects most biological - radioactive - and chemical substances and materials. Most notably, this will negate the effects of ash storms and give goliaths better grip against you." //GS13 - Nanotrasen to Genesis
	icon_state = "heva"
	item_state = "heva"
