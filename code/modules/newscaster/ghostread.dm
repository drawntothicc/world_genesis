...
/mob/dead/observer/proc/render_news_channel(datum/news/feed_channel/FC)
	...
	if(FC.censored) //GS13 - Nanotrasen to Genesis
		content += "<FONT COLOR='red'><B>ATTENTION: </B></FONT>This channel has been deemed as threatening to the welfare of the station, and marked with a Genesis D-Notice.<BR>"
