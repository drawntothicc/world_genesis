...
/obj/item/paper/pamphlet/gateway //GS13 - Nanotrasen to Genesis
	info = "<b>Welcome to the Genesis Gateway project...</b><br>\
			...
			winning dental plan- but that's not all the Genesis Gateway project has to offer.<br>\
			...
			As a participant in the Genesis Gateway Project, you will be on the frontiers of space. \
