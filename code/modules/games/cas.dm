...
/obj/item/toy/cards/deck/cas
	...
	var/blanks = 25
	var/decksize = 150
	var/card_text_file = "GainStation13/strings/cas_white.txt" //GS13 Edit: Nanotrasen to Genesis
...
/obj/item/toy/cards/deck/cas/black
	...
	blanks = 0
	decksize = 50
	card_text_file = "GainStation13/strings/cas_black.txt" //GS13 Edit: Nanotrasen to Genesis

/obj/item/toy/cards/deck/cas/populate_deck()
	var/static/list/cards_against_space = list("cas_white" = world.file2list("GainStation13/strings/cas_white.txt"),"cas_black" = world.file2list("GainStation13/strings/cas_black.txt")) //GS13 Edit: Nanotrasen to Genesis
