...
/datum/antagonist/traitor/internal_affairs
	...
	employer = "Genesis" //GS13 - Nanotrasen to Genesis
...
/datum/antagonist/traitor/internal_affairs/proc/greet_iaa()
	...
	if(syndicate)
		...
		to_chat(owner.current, "<span class='warningplain'><B><font size=5 color=red>Any damage you cause will be a further embarrassment to Genesis, so you have no limits on collateral damage.</font></B></span>") //GS13 - Nanotrasen to Genesis
