...
/datum/antagonist/ert/greet()
	...
	var/missiondesc = "Your squad is being sent on a mission to [station_name()] by Genesis's Security Division." //GS13 - Nanotrasen to Genesis
...
/datum/antagonist/ert/families/greet() //GS13 - Nanotrasen to Genesis
	var/missiondesc =  "<span class='warningplain'><B><font size=6 color=red>You are the [name].</font></B>"
	missiondesc += "<BR><B><font size=5 color=red>You are NOT a Genesis Employee. You work for the local government.</font></B>"
	...
	missiondesc += "<BR> <B>5.</B> Detain Genesis Security personnel if they harm any citizen."
...
/datum/antagonist/ert/families/undercover_cop/greet() //GS13 - Nanotrasen to Genesis
	var/missiondesc = "<span class='warningplain'><B><font size=3 color=red>You are the [name].</font></B>"
	missiondesc += "<BR><B><font size=3 color=red>You are NOT a Genesis Employee. You work for the local government.</font></B>"
	...
	missiondesc += "<BR> <B>3.</B> Remain undercover and do not get found out by Security or any gangs. Genesis does not take kindly to being spied on."
