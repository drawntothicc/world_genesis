...
/datum/gang_theme/construction_company_audit //GS13 - Nanotrasen to Genesis
	...
	gang_objectives = list(
		...
		/datum/antagonist/gang/irs = "Congratulations, agent! You've been assigned to the Internal Revenue Service case against Genesis and Majima Construction. \
		We are proud of your success as an agent so far, and are excited to see what you can bring to the table today. We suspect that Genesis and Majima Construction are engaging \
...
/datum/gang_theme/space_rosa //GS13 - Nanotrasen to Genesis
	...
	their comments on these scandals, but none have replied. News broke after a high profile break-in at a Genesis research facility resulted in the arrests of agents linked to these \
	three companies. All three companies denied any involvement, but the arrested individuals were found in an all out brawl. Curiously, Genesis reported nothing of value had \
