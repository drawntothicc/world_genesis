...
/datum/team/cult/roundend_report()
	...
	if(check_cult_victory())
		...
		parts += "<span class='redtext big'>The staff managed to stop the cult! Dark words and heresy are no match for Genesis's finest!</span>" //GS13 - Nanotrasen to Genesis
