...
/obj/item/clothing/accessory/medal/attack(mob/living/carbon/human/M, mob/living/user)
	if(ishuman(M) && (user.a_intent == INTENT_HELP))
		...
		if(M.w_uniform)
			...
			var/input
			if(!commended && user != M)
				input = stripped_input(user,"Please input a reason for this commendation, it will be recorded by Genesis.", ,"", 140) //GS13 - Nanotrasen to Genesis
...
/obj/item/clothing/accessory/medal/conduct
	...
	desc = "A bronze medal awarded for distinguished conduct. Whilst a great honor, this is the most basic award given by Genesis. It is often awarded by a captain to a member of his crew." //GS13 - Nanotrasen to Genesis
...
/obj/item/clothing/accessory/medal/silver/security
	...
	desc = "An award for distinguished combat and sacrifice in defence of Genesis's commercial interests. Often awarded to security staff." //GS13 - Nanotrasen to Genesis
...
/obj/item/clothing/accessory/medal/gold/captain
	...
	desc = "A golden medal awarded exclusively to those promoted to the rank of captain. It signifies the codified responsibilities of a captain to Genesis, and their undisputable authority over their crew." //GS13 - Nanotrasen to Genesis
...
/obj/item/clothing/accessory/pride
	name = "pride pin"
	desc = "A Genesis Diversity & Inclusion Center-sponsored holographic pin to show off your pride of sexuality or gender identity, reminding the crew of their unwavering commitment to equity, diversity, and inclusion!" //GS13 - Nanotrasen to Genesis
	icon_state = "pride"
	above_suit = TRUE
	obj_flags = UNIQUE_RENAME
	unique_reskin = list(
