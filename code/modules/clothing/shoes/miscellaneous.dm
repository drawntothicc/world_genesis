...
/obj/item/clothing/shoes/jackboots
	name = "jackboots"
	desc = "Genesis-brand jackboots for all your jackboots-related needs. From genuine combat to tacticool LARPing, satisfaction is guaranteed." //GS13 - Nanotrasen to Genesis
...
/obj/item/clothing/shoes/jackboots/sec
	...
	desc = "Genesis-issue Security combat boots for combat scenarios or combat situations. All combat, all the time." //GS13 - Nanotrasen to Genesis
...
/obj/item/clothing/shoes/workboots
	name = "work boots"
	desc = "Genesis-issue Engineering lace-up work boots for the especially blue-collar." //GS13 - Nanotrasen to Genesis
