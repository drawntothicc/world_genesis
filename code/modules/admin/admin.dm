...
/datum/admins/proc/access_news_network() //MARKER //GS13 - Nanotrasen to Genesis
	...
	switch(admincaster_screen)
		if(0)
			...
			dat+="<BR><A href='?src=[REF(src)];[HrefToken()];ac_menu_censor_channel=1'>Mark Feed Channel with Genesis D-Notice (disables and locks the channel).</A>"
