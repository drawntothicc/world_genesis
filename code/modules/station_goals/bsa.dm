...
/datum/station_goal/bluespace_cannon/get_report()
	return {"Our military presence is inadequate in your sector.
	 ...
	 -Genesis Naval Command"} //GS13 - Nanotrasen to Genesis
...
/obj/machinery/bsa/middle
	...
	desc = "Contents classified by Genesis Naval Command. Needs to be linked with the other BSA parts using multitool." //GS13 - Nanotrasen to Genesis
