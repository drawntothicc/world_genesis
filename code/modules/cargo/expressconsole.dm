...
/obj/machinery/computer/cargo/express
	...
	desc = "This console allows the user to purchase a package \
		with 1/40th of the delivery time: made possible by Genesis's new \"1500mm Orbital Railgun\".\
		All sales are near instantaneous - please choose carefully" //GS13 - Nanotrasen to Genesis
