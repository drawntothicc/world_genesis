...
/datum/bounty/item/silly/strange_object
	name = "Strange Object"
	description = "Genesis has taken an interest in strange objects. Find one in maint, and ship it off to CentCom right away." //GS13 - Nanotrasen to Genesis
	reward = 1000
...
/datum/bounty/item/silly/toy_swords
	name = "Toy Swords"
	description = "Genesis has secured a contract in a reenactment of a famous movie, but we only have lethal energy based swords. Send us some convincing replicas so we save on medical costs." //GS13 - Nanotrasen to Genesis
	reward = 1200
	required_count = 3
