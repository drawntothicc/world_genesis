/datum/bounty/item/science/boh
	name = "Bag of Holding"
	description = "Genesis would make good use of high-capacity backpacks. If you have any, please ship them." //GS13 - Nanotrasen to Genesis
	reward = 5000
	wanted_types = list(/obj/item/storage/backpack/holding)

/datum/bounty/item/science/tboh
	name = "Trash Bag of Holding"
	description = "Genesis would make good use of high-capacity trash bags. If you have any, please ship them." //GS13 - Nanotrasen to Genesis
	reward = 3000
	wanted_types = list(/obj/item/storage/bag/trash/bluespace)

/datum/bounty/item/science/bluespace_syringe
	name = "Bluespace Syringe"
	description = "Genesis would make good use of high-capacity syringes. If you have any, please ship them." //GS13 - Nanotrasen to Genesis
	reward = 1500
	wanted_types = list(/obj/item/reagent_containers/syringe/bluespace)

/datum/bounty/item/science/bluespace_body_bag
	name = "Bluespace Body Bag"
	description = "Genesis would make good use of high-capacity body bags. If you have any, please ship them." //GS13 - Nanotrasen to Genesis
	reward = 5000
