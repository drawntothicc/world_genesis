...
/datum/bounty/item/security/recharger
	name = "Rechargers"
	description = "Genesis military academy is conducting marksmanship exercises. They request that rechargers be shipped." //GS13 - Nanotrasen to Genesis
	reward = 1700
	required_count = 3
...
/datum/bounty/item/security/practice
	...
	description = "Genesis Military Academy is conducting routine marksmanship exercises. The clown hid all the practice lasers, and we're not using live weapons after last time." //GS13 - Nanotrasen to Genesis
	reward = 1500
	required_count = 3
...
/datum/bounty/item/security/sechuds
	name = "Sec HUDs"
	description = "Genesis military academy has started to train officers how to use Sec HUDs to the fullest affect. Please send spare Sec HUDs so we can teach the men." //GS13 - Nanotrasen to Genesis
	reward = 1250
	required_count = 5
...
/datum/bounty/item/security/techslugs
	name = "Tech Slugs"
	description = "Genesis Military Academy is conducting an ammo loading and use lessons, on the new 'Tech Slugs'. Problem is we don't have any, please fix this..." //GS13 - Nanotrasen to Genesis
	reward = 3500
	required_count = 15
...
/datum/bounty/item/security/wt550
	...
	description = "Genesis Military Academy's ammunition is running low, please send in spare ammo for practice." //GS13 - Nanotrasen to Genesis
	reward = 1500
	required_count = 5
...
/datum/bounty/item/security/pins
	...
	description = "Genesis Military Academy just got a new set of guns, sadly they didn't come with any pins. Can you send us some Test range locked firing pins?" //GS13 - Nanotrasen to Genesis
	reward = 2750
	required_count = 3
