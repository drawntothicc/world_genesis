...
/datum/bounty/item/assistant/scooter
	name = "Scooter"
	description = "Genesis has determined walking to be wasteful. Ship a scooter to CentCom to speed operations up." //GS13 - Nanotrasen to Genesis
...
/datum/bounty/item/assistant/skateboard
	name = "Skateboard"
	description = "Genesis has determined walking to be wasteful. Ship a skateboard to CentCom to speed operations up." //GS13 - Nanotrasen to Genesis
...
/datum/bounty/item/assistant/ied
	name = "IED"
	description = "Genesis's maximum security prison at CentCom is undergoing personnel training. Ship a handful of IEDs to serve as a training tools." //GS13 - Nanotrasen to Genesis
	reward = 2000
	required_count = 3
