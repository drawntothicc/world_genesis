/datum/bounty/item/chef/birthday_cake
	name = "Birthday Cake"
	description = "Genesis's birthday is coming up! Ship them a birthday cake to celebrate!" //GS13 - Nanotrasen to Genesis
	reward = 1800
...
/datum/bounty/item/gardencook/onionrings
	name = "Onion Rings"
	description = "Genesis is remembering Saturn day. Ship onion rings to show the station's support." //GS13 - Nanotrasen to Genesis
	reward = 1200
	required_count = 3
