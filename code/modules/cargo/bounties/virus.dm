...
/datum/bounty/virus/New()
	...
	description = "Genesis is interested in a virus with a [stat_name] stat of exactly [stat_value]. Central Command will pay handsomely for such a virus." //GS13 - Nanotrasen to Genesis
	reward += rand(0, 4) * 400
