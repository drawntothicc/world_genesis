...
/datum/bounty/item/medical/lizard_tail
	name = "Lizard Tail"
	description = "The Wizard Federation has made off with Genesis's supply of lizard tails. While CentCom is dealing with the wizards, can the station spare a tail of their own?" //GS13 - Nanotrasen to Genesis
	reward = 3000
...
/datum/bounty/item/medical/blood
	name = "Generic Blood"
	description = "Genesis's annual blood drive is back up to full speed, following the garlic incident. Good blood in good volumes accepted for Credit returns." //GS13 - Nanotrasen to Genesis
	reward = 3500
	required_count = 600
