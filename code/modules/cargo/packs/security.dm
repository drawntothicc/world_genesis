...
/datum/supply_pack/security/forensics
	...
	desc = "Stay hot on the criminal's heels with Genesis's Detective Essentials(tm). Contains a forensics scanner, six evidence bags, camera, tape recorder, white crayon, and of course, a fedora. Requires Security access to open." //GS13 - Nanotrasen to Genesis
	cost = 1800
...
/datum/supply_pack/security/justiceinbound
	...
	desc = "This is it. The Bee's Knees. The Creme of the Crop. The Pick of the Litter. The best of the best of the best. The Crown Jewel of Genesis. The Alpha and the Omega of security headwear. Guaranteed to strike fear into the hearts of each and every criminal aboard the station. Also comes with a security gasmask. Requires Security access to open." //GS13 - Nanotrasen to Genesis
