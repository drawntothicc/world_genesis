...
/datum/supply_pack/organic/hydroponics/beekeeping_fullkit
	...
	desc = "BEES BEES BEES. Contains three honey frames, a beekeeper suit & helmet, flyswatter, bee house, and, of course, a pure-bred Genesis-Standardized Queen Bee!" //GS13 - Nanotrasen to Genesis
	cost = 1800
...
/datum/supply_pack/organic/party
	...
	desc = "Celebrate both life and death on the station with Genesis's Party Essentials(tm)! Contains seven colored glowsticks, four beers, two ales, a drinking shaker, and a bottle of patron & goldschlager!" //GS13 - Nanotrasen to Genesis
	cost = 2000
