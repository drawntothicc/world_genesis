...
/datum/supply_pack/goody/combatknives_single
	...
	desc = "Contains one sharpened combat knive. Guaranteed to fit snugly inside any Genesis-standard boot." //GS13 - Nanotrasen to Genesis
	cost = 800
...
/datum/supply_pack/goody/beach_ball
	name = "Beach Ball"
	desc = "The simple beach ball is one of Genesis's most popular products. 'Why do we make beach balls? Because we can! (TM)' - Genesis" //GS13 - Nanotrasen to Genesis
	cost = 200
