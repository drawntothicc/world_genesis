...
/datum/supply_pack/service/janitor/starter
	...
	desc = "Fight back against dirt and grime with Genesis's Janitorial Essentials(tm)! Contains three buckets, caution signs, and cleaner grenades. Also has a single mop, spray cleaner, rag, GT soap and a trash bag." //GS13 - Nanotrasen to Genesis
	cost = 1300
