...
/datum/supply_pack/misc/book_crate
	name = "Book Crate"
	desc = "Surplus from the Genesis Archives, these seven books are sure to be good reads." //GS13 - Nanotrasen to Genesis
...
/datum/supply_pack/misc/bicycle
	name = "Bicycle"
	desc = "Genesis reminds all employees to never toy with powers outside their control." //GS13 - Nanotrasen to Genesis
	cost = 1000000
...
/datum/supply_pack/misc/potted_plants
	...
	desc = "Spruce up the station with these lovely plants! Contains a random assortment of five potted plants from Genesis's potted plant research division. Warranty void if thrown." //GS13 - Nanotrasen to Genesis
	cost = 730
