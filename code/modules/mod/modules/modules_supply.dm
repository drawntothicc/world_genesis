...
/obj/item/mod/module/gps
	...
	desc = "This module uses common Genesis technology to calculate the user's position anywhere in space, \
		down to the exact coordinates. This information is fed to a central database viewable from the device itself, \
		though using it to help people is up to you." //GS13 - Nanotrasen to Genesis
	icon_state = "gps"
...
/obj/item/mod/module/clamp
	...
	desc = "A series of actuators installed into both arms of the suit, boasting a lifting capacity of almost a ton. \
		However, this design has been locked by Genesis to be primarily utilized for lifting various crates. \
		A lot of people would say that loading cargo is a dull job, but you could not disagree more." //GS13 - Nanotrasen to Genesis
	icon_state = "clamp"
