/obj/structure/closet/wardrobe
	name = "wardrobe"
	desc = "It's a storage unit for standard-issue Genesis attire." //GS13 - Nanotrasen to Genesis
	icon_door = "blue"
...
/obj/structure/closet/wardrobe/orange
	...
	desc = "It's a storage unit for Genesis-regulation prisoner attire." //GS13 - Nanotrasen to Genesis
	icon_door = "orange"
