...
/obj/item/book/manual/ripley_build_and_repair //GS13 - Nanotrasen to Genesis
	...
	dat = {"<html>
				...
				<li>Install the internal armor plating (Not included due to Genesis regulations. Can be made using 5 metal sheets.)</li>
				<li>Secure the internal armor plating with a wrench</li>
				<li>Weld the internal armor plating to the chassis</li>
				<li>Install the external reinforced armor plating (Not included due to Genesis regulations. Can be made using 5 reinforced metal sheets.)</li>
				...
				<h2>Operation</h2>
				Please consult the Genesis compendium "Robotics for Dummies".
			"}
...
/obj/item/book/manual/nuclear //GS13 - Nanotrasen to Genesis
	...
	dat = {"<html>
			...
			Today's crash course will deal with the operation of a Fusion Class Genesis made Nuclear Device.<br>
			...
			Note: Genesis is a pain in the neck.<br>
			...
			Intelligence Analysts believe that normal Genesis procedure is for the Captain to secure the nuclear authorisation disk.<br>
			Good luck!
			</body>
			</html>"}
