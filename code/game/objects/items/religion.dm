/obj/item/banner
	name = "banner"
	desc = "A banner with Genesis's logo on it." //GS13 - Nanotrasen to Genesis
...
/obj/item/banner/command
	...
	warcry = "Hail Genesis!" //GS13 - Nanotrasen to Genesis
...
/obj/item/storage/backpack/bannerpack
	name = "Genesis banner backpack" //GS13 - Nanotrasen to Genesis
	desc = "It's a backpack with lots of extra room.  A banner with Genesis's logo is attached, that can't be removed." //GS13 - Nanotrasen to Genesis
