...
/obj/item/paper/guides/antag/nuke_instructions //GS13 - Nanotrasen to Genesis
	info = "How to break into a Genesis self-destruct terminal and remove its plutonium core:<br>\
	<ul>\
