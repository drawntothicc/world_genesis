...
/obj/machinery/computer/secure_data/laptop
	...
	desc = "A cheap Genesis security laptop, it functions as a security records console. It's bolted to the table." //GS13 - Nanotrasen to Genesis
	icon_state = "laptop"
...
<th>Time Added</th>
			...
			if("Print Poster")
				if(!( printing ))
					...
					if(wanted_name)
						var/default_description = "A poster declaring [wanted_name] to be a dangerous individual, wanted by Genesis. Report any sightings to security immediately." //GS13 - Nanotrasen to Genesis
