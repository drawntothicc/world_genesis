...
/datum/game_mode/traitor/changeling/generate_report()
	return "The Syndicate has started some experimental research regarding humanoid shapeshifting.  There are rumors that this technology will be field tested on a Genesis station \
			...
			as paranoia may spread and inhibit workplace efficiency." //GS13 - Nanotrasen to Genesis
