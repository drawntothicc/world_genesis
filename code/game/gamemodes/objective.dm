...
/datum/objective/freedom
	name = "freedom"
	explanation_text = "Don't get captured by Genesis." //GS13 - Nanotrasen to Genesis
	team_explanation_text = "Have all members of your team free of Genesis custody." //GS13 - Nanotrasen to Genesis
