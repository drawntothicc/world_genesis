...
/datum/game_mode/traitor/internal_affairs
	...
	reroll_friendly = 0
	chaos = 7
	traitor_name = "Genesis Internal Affairs Agent" //GS13 - Nanotrasen to Genesis
	...
	announce_text = "There are Genesis Internal Affairs Agents trying to kill each other!\n\
	<span class='danger'>IAA</span>: Eliminate your targets and protect yourself!\n\
	<span class='notice'>Crew</span>: Stop the IAA agents before they can cause too much mayhem." //GS13 - Nanotrasen to Genesis
...
/datum/game_mode/traitor/internal_affairs/generate_report()
	return "Genesis denies any accusations of placing internal affairs agents onboard your station to eliminate inconvenient employees.  Any further accusations against CentCom for such \
			actions will be met with a conversation with an official internal affairs agent." //GS13 - Nanotrasen to Genesis
