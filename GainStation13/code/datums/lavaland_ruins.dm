...
/datum/map_template/ruin/lavaland/gainium_altar //GS13
	name = "gainium Altar"
	id = "gainiumaltar"
	description = "A mysterious fountain stands dormant amidst a small gainium shrine... What could it possibly offer?"
	suffix = "lavaland_surface_gainiumaltar.dmm"
	allow_duplicates = TRUE
	cost = 0


/datum/map_template/ruin/lavaland/gainium_shrine //GS13
	name = "gainium Shrine"
	id = "gainiumshrine"
	description = "Somewhere on this planet, a gluttony deity is worshipped for food and life."
	suffix = "lavaland_surface_gainiumshrine.dmm"
	allow_duplicates = TRUE
	cost = 0
